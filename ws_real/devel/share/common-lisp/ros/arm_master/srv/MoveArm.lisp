...
(cl:defmethod cl:initialize-instance :after ((m <MoveArm-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveArm-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_master-srv:<MoveArm-request> is deprecated: use arm_master-srv:MoveArm-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <MoveArm-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_master-srv:x-val is deprecated.  Use arm_master-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <MoveArm-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_master-srv:y-val is deprecated.  Use arm_master-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <MoveArm-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_master-srv:z-val is deprecated.  Use arm_master-srv:z instead.")
  (z m))

(cl:ensure-generic-function 'rot_x-val :lambda-list '(m))
(cl:defmethod rot_x-val ((m <MoveArm-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_master-srv:rot_x-val is deprecated.  Use arm_master-srv:rot_x instead.")
  (rot_x m))

(cl:ensure-generic-function 'rot_y-val :lambda-list '(m))
(cl:defmethod rot_y-val ((m <MoveArm-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_master-srv:rot_y-val is deprecated.  Use arm_master-srv:rot_y instead.")
  (rot_y m))

(cl:ensure-generic-function 'rot_z-val :lambda-list '(m))
(cl:defmethod rot_z-val ((m <MoveArm-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_master-srv:rot_z-val is deprecated.  Use arm_master-srv:rot_z instead.")
  (rot_z m))
...
(cl:defmethod cl:initialize-instance :after ((m <MoveArm-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveArm-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name arm_master-srv:<MoveArm-response> is deprecated: use arm_master-srv:MoveArm-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <MoveArm-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader arm_master-srv:success-val is deprecated.  Use arm_master-srv:success instead.")
  (success m))
