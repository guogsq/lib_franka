// Generated by gencpp from file franka_msgs/SetFullCollisionBehaviorRequest.msg
// DO NOT EDIT!


#ifndef FRANKA_MSGS_MESSAGE_SETFULLCOLLISIONBEHAVIORREQUEST_H
#define FRANKA_MSGS_MESSAGE_SETFULLCOLLISIONBEHAVIORREQUEST_H
...
struct SetFullCollisionBehaviorRequest_
{
  ...
  typedef boost::shared_ptr< ::franka_msgs::SetFullCollisionBehaviorRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::franka_msgs::SetFullCollisionBehaviorRequest_<ContainerAllocator> const> ConstPtr;

}; // struct SetFullCollisionBehaviorRequest_

typedef ::franka_msgs::SetFullCollisionBehaviorRequest_<std::allocator<void> > SetFullCollisionBehaviorRequest;

typedef boost::shared_ptr< ::franka_msgs::SetFullCollisionBehaviorRequest > SetFullCollisionBehaviorRequestPtr;
typedef boost::shared_ptr< ::franka_msgs::SetFullCollisionBehaviorRequest const> SetFullCollisionBehaviorRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::franka_msgs::SetFullCollisionBehaviorRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::franka_msgs::SetFullCollisionBehaviorRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::franka_msgs::SetFullCollisionBehaviorRequest_<ContainerAllocator1> & lhs, const ::franka_msgs::SetFullCollisionBehaviorRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct HasHeader< ::franka_msgs::SetFullCollisionBehaviorRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::franka_msgs::SetFullCollisionBehaviorRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::franka_msgs::SetFullCollisionBehaviorRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::franka_msgs::SetFullCollisionBehaviorRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xbc875909c147220bULL;
  static const uint64_t static_value2 = 0xa1720adcd48e47eaULL;
};

template<class ContainerAllocator>
struct DataType< ::franka_msgs::SetFullCollisionBehaviorRequest_<ContainerAllocator> >
{
  static const char* value()
  {
    return "franka_msgs/SetFullCollisionBehaviorRequest";
  }
...
template<class ContainerAllocator>
struct Definition< ::franka_msgs::SetFullCollisionBehaviorRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::franka_msgs::SetFullCollisionBehaviorRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::franka_msgs::SetFullCollisionBehaviorRequest_<ContainerAllocator> >
{
...
#endif // FRANKA_MSGS_MESSAGE_SETFULLCOLLISIONBEHAVIORREQUEST_H
