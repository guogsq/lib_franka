...
bool operator==(const ::franka_control::SetFullCollisionBehaviorResponse_<ContainerAllocator1> & lhs, const ::franka_control::SetFullCollisionBehaviorResponse_<ContainerAllocator2> & rhs)
{
