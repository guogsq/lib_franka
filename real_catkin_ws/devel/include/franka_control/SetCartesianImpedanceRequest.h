...
bool operator==(const ::franka_control::SetCartesianImpedanceRequest_<ContainerAllocator1> & lhs, const ::franka_control::SetCartesianImpedanceRequest_<ContainerAllocator2> & rhs)
{
